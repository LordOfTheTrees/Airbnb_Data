...
# ============================================================================
# Helper functions are now imported from utils.helpers:
# - sanitize_text()
# - analyze_variable()
# - create_variable_summary_table()
# - create_all_correlation_matrices()
...
def analyze_city(city_name, base_dir='.', use_detailed=False):
    ...
    # Create output directory in portfolio_outputs
    output_dir = Path('portfolio_outputs') / 'per_city' / city_name / 'analysis_output'
